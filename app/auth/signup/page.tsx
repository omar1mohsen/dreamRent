...
function Page() {
  ...
  const [phonError, setPhonError] = useState<string | null>();
  ...
  const { name, number, address, email, password } = formData;
...
if(nameError || passError || passError || emailError){
  return
    ...
    try {
      ...
      await signUp(email, password , formDataCopy)
    } catch (err) {
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <form onSubmit={creatNewUser}>
                <div>
                    ...
                    <div className="w-full px-3 mb-5">
                      ...
                      <div className="flex">
                        ...
                        <input
                          ...
                          value={address}
                          className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                          placeholder="Suzy Queue 4455 Landing Lange, APT 4 Louisville"
                          onChange={onChange}
                        />
                      </div>
                    </div>
                  ...
                  <AuthNavigate linkToSignUp={false} />
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <button
                        type="submit"
